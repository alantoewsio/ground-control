  ...
  (function () {
    var SYNC_CATALOG = [{"id": "ip_host", "label": "IP Host"}];
    var LS_KEY_SYNC = "ground-control-fw-sync-entities-v1";
    var gcFwFlyoutSyncUrl = "";
    var GC_DELETE_BATCH_URL = "/d";
    var GC_CACHED_SYNC_TYPES_URL = "http://x/api_firewalls_cached_sync_entity_types";
    var COLS = [
      { id: "name", label: "Name" },
    ...
    if (editForm) {
      editForm.addEventListener("submit", function (e) {
        ...
        fetch(editForm.getAttribute("action") || "/u", {
          method: "POST",
          body: fd,
          credentials: "same-origin",
          headers: { Accept: "application/json", "X-Requested-With": "Ground-Control" },
    ...
    <script src="/static/task-queue-dock.js" defer></script>
    <script src="/static/task-queue-badge.js" defer></script>
    <script src="/static/auth-app.js" defer>